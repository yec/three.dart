...
class PathAction {
  ...
  static const String QUADRATIC_CURVE_TO =
...
class Path extends CurvePath {
  ...
  addAction(String action, [var args]) =>
  ...
  ellipse(aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise) {
    ...
    absellipse(
        aX + x0, aY + y0, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise);
  }
    ...
    for (i = 0; i < actions.length; i++) {
      ...
      switch (action) {
        ...
        case PathAction.CSPLINE_THRU:
          ...
          var last =
              new Vector2(laste[laste.length - 2], laste[laste.length - 1]);
          var spts = [last];
